...
public class CompanyNameChangePage extends PageObjectUtils{
	...
	public void is_company_name_change_selected() {
		selectbyVisibleText(selectList, "Company Name Change");
	}
	...
	public void enter_new_company_name(String newCompanyName) {
		check_before_sending_keys(new_company_name, new_company_name_label, "Enter Company Name", "New Company Name", "Company Name");
