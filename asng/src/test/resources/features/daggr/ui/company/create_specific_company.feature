Feature: Company Database
  ...
  Scenario Template: <testcase>
    ...
    Examples: 
      ...
      | Create a public rss company with all fields | gopikumar@digital-nirvana.com | Gopi Kumar Jeedimalla | Dnis@123 | TL   | https://www.kroger.in/ | Apple Store Aut | Public       | Active         | https://www.test1.in/ |        56 | 2000-02-13 | 2040-02-13 | Health Care | IT       | United States | Alaska | College | 1-1542/A Beckkam street, North Atlanta |   9999999999 | It is basically IT company | svv6520h | 56214235 | c511w1 | fssv523 | https://chubb.ir-section | https://chubb.pr-section | xyz     | Team Lead      |      9999999999 | xyz@gmail.com | Yes                    | No                     | https://chubb.executives-section | https://chubb.analyst-coverage | https://chubb.analyst-coverage | Yes                   | No                      | Telugu,Tamil,French | Yearly                  | Yes               | No                     | Company Comments | RSS Feed      | https://www.utah.gov/whatsnew/rss.xml | ACTIVE          | 1 month            | Data Source Comments | ACT    | NASDAQ - NASDAQ | Preferred Stock | Class B           | 2020-03-26         | 2024-03-26       | Active         | Yes            |

  @public_manual_company
  Scenario Template: <testcase>
    Given I Launch Daggr Application
    When I enter "<email>" and "<password>"
    And I click Daggr Signin button
  ...
  @public_rss_company_only_mandatory
  Scenario Template: <testcase>
    Given I Launch Daggr Application
    When I enter "<email>" and "<password>"
    And I click Daggr Signin button
  ...
  @public_manual_company_only_mandatory
  Scenario Template: <testcase>
    Given I Launch Daggr Application
    When I enter "<email>" and "<password>"
    And I click Daggr Signin button
  ...
  @private_rss_company_only_mandatory
  Scenario Template: <testcase>
    Given I Launch Daggr Application
    When I enter "<email>" and "<password>"
    And I click Daggr Signin button
  ...
  @private_manual_company_only_mandatory
  Scenario Template: <testcase>
    Given I Launch Daggr Application
    When I enter "<email>" and "<password>"
    And I click Daggr Signin button
