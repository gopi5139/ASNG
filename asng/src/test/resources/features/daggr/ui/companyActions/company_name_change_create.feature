Feature: Company Name Change
  ...
  Scenario Template: <testcase>
    ...
    Examples: 
      ...
      | Create a Company Name Change with all fields | gopikumar@digital-nirvana.com | Dnis@123 | Gopi Kumar Jeedimalla | TL   | https://www.kroger.in/ | Zomato       | Git Hub          | 2021-11-26     | Asia/Kolkata |
