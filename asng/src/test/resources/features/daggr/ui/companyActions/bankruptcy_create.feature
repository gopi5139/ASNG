Feature: Bankruptcy
  ...
  Scenario Template: <testcase>
    ...
    Examples: 
      ...
      | Create a Bankruptcy with all fields | gopikumar@digital-nirvana.com | Dnis@123 | Gopi Kumar Jeedimalla | TL   | https://www.kroger.in/ | Zomato       | Chapter 7       | 2021-11-26     | Asia/Kolkata |
