Feature: Spinoff
  ...
  Scenario Template: <testcase>
    ...
    Examples: 
      | testcase                                | email                         | password | user_name             | role | article_url            | parent_company_name | spin_off_company_name | effective_date | time_zone    |
      | Create a spinoff with 1 spinoff company | gopikumar@digital-nirvana.com | Dnis@123 | Gopi Kumar Jeedimalla | TL   | https://www.kroger.in/ | Decathlon           | wipro                 | 2021-12-22     | Asia/Kolkata |

  @spinoff_with_2_company
  Scenario Template: <testcase>
    Given I Launch Daggr Application
    When I enter "<email>" and "<password>"
    And I click Daggr Signin button
    ...
    Examples: 
      ...
      | Create a spinoff with 2 spinoff company | gopikumar@digital-nirvana.com | Dnis@123 | Gopi Kumar Jeedimalla | TL   | https://www.kroger.in/ | Decathlon           | wipro                 | Charles River Laboratories International, inc | 2021-11-22     | Asia/Kolkata |
