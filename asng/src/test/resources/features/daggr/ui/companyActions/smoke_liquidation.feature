Feature: Liquidation
  ...
  Scenario Template: <testcase>
    ...
    Examples: 
      ...
      | Create a Liquidation | gopikumar@digital-nirvana.com | Dnis@123 | Gopi Kumar Jeedimalla | TL   | https://www.kroger.in/ | wipro        | 2021-11-22     | Asia/Kolkata |
