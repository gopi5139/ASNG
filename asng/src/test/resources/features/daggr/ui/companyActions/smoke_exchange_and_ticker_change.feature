Feature: Exchange & Ticker Change
  ...
  @smoke_exchange_and_ticker_change @smoke
  Scenario Template: <testcase>
    ...
    Examples: 
      ...
      | Create a Exchange and Ticker Change | gopikumar@digital-nirvana.com | Dnis@123 | Gopi Kumar Jeedimalla | TL   | https://www.kroger.in/ | Zomato       | RTY-NASDAQ      | CASE         | ZTO        | 2021-11-26     | Asia/Kolkata |
