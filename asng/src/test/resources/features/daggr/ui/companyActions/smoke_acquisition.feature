Feature: Acquisition
  ...
  Scenario Template: <testcase>
    ...
    Examples: 
      ...
      | Create a post acquisition | gopikumar@digital-nirvana.com | Dnis@123 | Gopi Kumar Jeedimalla | TL   | https://www.kroger.in/ | Decathlon             | wipro               | 2021-11-22     | Asia/Kolkata | Yes                                   | Marsh            |
