Feature: Delisted
  ...
  Scenario Template: <testcase>
    ...
    Examples: 
      ...
      | Create a Delisted | gopikumar@digital-nirvana.com | Dnis@123 | Gopi Kumar Jeedimalla | TL   | https://www.kroger.in/ | Zomato       | RTY-NASDAQ      | Delisted       | true                    | 2021-11-14     | Asia/Kolkata |
