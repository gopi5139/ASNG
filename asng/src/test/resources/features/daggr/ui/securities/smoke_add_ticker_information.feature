Feature: Add Ticker Information
  ...
  Scenario Template: <testcase>
    ...
    Examples: 
      ...
      | Create ticker information | gopikumar@digital-nirvana.com | Gopi Kumar Jeedimalla | Dnis@123 | TL   | https://www.kroger.in/ | Zomato       | ZMO    | NASDAQ    | Preferred Stock | Class B           | 2020-03-26         | 2024-03-26       | Delisted       | No             |

  @smoke_update_ticker @smoke
  Scenario Template: <testcase>
    Given I Launch Daggr Application
    When I enter "<email>" and "<password>"
    And I click Daggr Signin button
    ...
    Examples: 
      ...
      | Update ticker information | gopikumar@digital-nirvana.com | Gopi Kumar Jeedimalla | Dnis@123 | TL   | https://www.kroger.in/ | Zomato       | ZMO    | NASDAQ    | Preferred Stock | Class B           | 2020-03-26         | 2024-03-26       | Delisted       | No             | Decathlon           | ZMQ           | CASE             | Depository Receipt   | Class D                  | 2021-09-26                | 2021-12-25              | Suspended             | No                    |
