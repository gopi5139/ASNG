Feature: Add Tracking Information
  ...
  @smoke_create_add_tracking_information @smoke
  Scenario Template: <testcase>
    ...
    Examples: 
      ...
      | Create a Add Tracking Information | gopikumar@digital-nirvana.com | Gopi Kumar Jeedimalla | Dnis@123 | TL   | https://mail.google.com/mail/u/0/?tab=rinbox | Hathway      | RSS           | https://www.financialexpress.com/feed/ | Active          | 1 month            | Ceomments |

  @smoke_update_add_tracking_information @smoke
  Scenario Template: <testcase>
    Given I Launch Daggr Application
    When I enter "<email>" and "<password>"
    And I click Daggr Signin button
    ...
    Examples: 
      | testcase                          | email                         | user_name             | password | role | article_link                                 | company_name | tracking_type | tracking_link                           | tracking_status | scraping_frequency | comments  | update_tracking_status | update_scraping_frequency |
      | Update a Add Tracking Information | gopikumar@digital-nirvana.com | Gopi Kumar Jeedimalla | Dnis@123 | TL   | https://mail.google.com/mail/u/0/?tab=rinbox | Hathway      | RSS           | https://epsilon.webnode.com/rss/all.xml | Active          | 1 month            | Ceomments | Inactive               | 4 weeks                   |
